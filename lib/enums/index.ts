export const ACCOUNT_EVENT_TYPE = {
  CREDIT: 'credit',
  DEBIT: 'debit'
}
export const COLLECTION_UPLOAD = {
  title: 'Title',
  seo_title: 'SEO Title',
  handle: 'Handle',
...
export const PRODUCT_REVIEW_UPLOAD = {
  handle: 'Handle',
  id: 'ID',
...
export const PRODUCT_META_UPLOAD = {
  handle: 'Handle',
  id: 'ID',
  product_id: 'Product ID'
}
export const SUBSCRIPTION_UPLOAD = {
  products: 'Products',
  customer: 'Customer',
  interval: 'Interval',
  unit: 'Unit',
...
export const ORDER_FULFILLMENT_KIND = {
...
export const FULFILLMENT_EVENT_STATUS = {
...
export const PAYMENT_PROCESSING_METHOD = {
...
export const TRANSACTION_KIND = {
  // Money that the customer has agreed to pay. Authorization period lasts for up to 7 to 30 days
  // (depending on your payment service) while a store awaits for a customer's capture.
  AUTHORIZE: 'authorize',
...
export const COLLECTION_DISCOUNT_SCOPE = {
  INDIVIDUAL: 'individual',
  GLOBAL: 'global'
}
...
export const COLLECTION_TAX_TYPE = {
  PERCENTAGE: 'percentage',
  FIXED: 'fixed',
}
export const COLLECTION_SHIPPING_TYPE = {
  PERCENTAGE: 'percentage',
  FIXED: 'fixed',
}
